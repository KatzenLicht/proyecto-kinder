...
// ============================================================
// registro_padre.php
// Registro de nuevos padres / tutores
// ============================================================
        ...
        <form action="api/registro_padre_proceso.php" method="POST" class="login-form">
            ...
            <div class="form-group">
                ...
                <div class="input-password">
                    <input type="password" name="password_usu" id="pass1"
            ...
            <div class="form-group">
                ...
                <input type="tel" name="telefono_padre"
                       placeholder="Ej: 6561234567" maxlength="12" required>
            </div>

            <div class="form-group">
                <label>Correo electrónico</label>
                <input type="email" name="correo_padre"
